...
COMMON_FILTERS = aresample scale crop overlay hstack vstack fps amix volume mpdecimate
COMMON_DEMUXERS = matroska ogg mov mp3 wav
...
MP4_MUXERS = mp4 mp3 image2 null
